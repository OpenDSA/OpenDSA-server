...
public class studentpntrsamendePROG {
...
boolean SUCCESS = false;
  ...
  if (Mq.element() == studentHead.element()) SUCCESS = true;
  ...
  PrintWriter output = new PrintWriter("output", "UTF-8");
   ...
   {
     output.println("Try Again! You either disconnected the links or incorrectly reassigned the variable q.");
     output.close();
